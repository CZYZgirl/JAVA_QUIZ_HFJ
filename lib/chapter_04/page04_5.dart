...
class Page045 extends StatefulWidget {
  @override
  _Page045State createState() => _Page045State();
}

class _Page045State extends State<Page045> {
  // list of code snippets to be selected
  ...
  // builds the puzzle code section
